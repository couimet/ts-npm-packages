...
- **Package README badge rows follow the canonical badge form.** The row reads npm version, then npm downloads, then Coverage. A package with no coverage badge reads npm version, then npm downloads. Badge URLs carry no style parameter. The form comes from <https://github.com/couimet/idea-garden/blob/main/docs/standards/readme-badges.md>, which orders badges by what they measure rather than by how they render.
