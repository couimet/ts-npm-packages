...
- Add `getUniqueStrings()` and `getUniqueStringsNamed()` batch wrappers for unique strings.
...
[1.1.0]: https://github.com/couimet/ts-npm-packages/compare/%40couimet%2Fdynamic-testing%401.0.1...%40couimet%2Fdynamic-testing%401.1.0
