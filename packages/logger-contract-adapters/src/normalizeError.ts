/** Converts an `Error` into a JSON-serializable plain object carrying its `name`, `message`, `stack`, and own enumerable properties; non-`Error` values pass through unchanged. */
