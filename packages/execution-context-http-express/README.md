...
[![npm version](https://img.shields.io/npm/v/@couimet/execution-context-http-express)](https://www.npmjs.com/package/@couimet/execution-context-http-express) [![npm downloads](https://img.shields.io/npm/dm/@couimet/execution-context-http-express)](https://www.npmjs.com/package/@couimet/execution-context-http-express) [![Coverage](https://codecov.io/gh/couimet/ts-npm-packages/branch/main/graph/badge.svg?flag=execution-context-http-express)](https://codecov.io/gh/couimet/ts-npm-packages?flags%5B0%5D=execution-context-http-express)
