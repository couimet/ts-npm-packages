...
[![npm version](https://img.shields.io/npm/v/@couimet/execution-context-http.svg?style=flat-square)](https://www.npmjs.com/package/@couimet/execution-context-http) [![Coverage](https://codecov.io/gh/couimet/ts-npm-packages/branch/main/graph/badge.svg?flag=execution-context-http)](https://codecov.io/gh/couimet/ts-npm-packages?flags%5B0%5D=execution-context-http) [![npm downloads](https://img.shields.io/npm/dm/@couimet/execution-context-http.svg?style=flat-square)](https://www.npmjs.com/package/@couimet/execution-context-http)
